...
/*
editText.getText().toString(), spin.getSelectedItemId())
 */
                        newarticle.setLibelle(editText.getText().toString());                       // myAdapterArt.add(datasource.createArticle(editText.getText().toString(), spin.getSelectedItemId()));
                        newarticle.setFamilleId(spin.getSelectedItemId());

                        myAdapterArt.add(datasource.createArticle(newarticle));
                        editText.setText("");
                    }
